...
public class NeuralCell {
	...
	protected static int lastCellID = -1;
	...
	protected ArrayList<NeuralCell> lowerCells = new ArrayList<NeuralCell>(0);  //The cells from previous layer
	protected ArrayList<Double> weights = new ArrayList<Double>(0);
	protected ArrayList<Double> previous_weights_incremental = new ArrayList<Double>(0);
